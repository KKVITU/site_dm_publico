                        ...
                        <div class="card">
                            <div class="card-body">
                                <div style="max-width:100%; " class="table-overflow">
                                    ...
                                    ?>
                                    <form id="form_avisos" class="needs-validation" novalidate method="POST" action="processa_dados_editados.php">
                                        <div class="row">

                                            <input hidden type="text" value="<?php echo $id; ?>" name="id" id="id">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control" value="<?php echo $nome_cliente ?>" type="text" placeholder="" name="nome_cliente" id="nome_cliente">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control" value="<?php echo $nacionalidade ?>" type="text" placeholder="" name="nacionalidade" id="nacionalidade">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control" value="<?php echo $naturalidade ?>" type="text" placeholder="" name="naturalidade" id="naturalidade">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control" value="<?php echo $linha['data_nascimento'] ?>" type="date" placeholder="" name="dt_nasc" id="dt_nasc">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control" value="<?php echo $profissao ?>" type="text" placeholder="" name="profissao" id="profissao">
                                                    <div class="invalid-feedback">
                                                        Insira a Profissão
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control" value="<?php echo $identidade ?>" type="text" placeholder="" name="identidade" id="identidade">
                                                    <div class="invalid-feedback">
                                                        Insira a Identidade
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input required class="form-control" type="text" value="<?php echo $orgao_expedidor ?>" placeholder="" name="oex_identidade" id="oex_identidade" oninput="adicionarBarra()">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control" value="<?php echo $cpf ?>" type="text" placeholder="" name="cpf" id="cpf" maxlength="14" oninput="formatarCPF(this)">
                                                    <div class="invalid-feedback">
                                                        Insira o CPF
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control" value="<?php echo $rua ?>" type="text" placeholder="" name="rua" id="rua">
                                                    <div class="invalid-feedback">
                                                        Insira a Rua
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control" value="<?php echo $bairro ?>" type="text" placeholder="" name="bairro" id="bairro">
                                                    <div class="invalid-feedback">
                                                        Insira o Bairro
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control" value="<?php echo $cep ?>" type="text" placeholder="" name="cep" id="cep" maxlength="9" oninput="formatarCEP(this)">
                                                    <div class="invalid-feedback">
                                                        Insira o CEP
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control" value="<?php echo $numero_casa ?>" type="text" placeholder="" name="num_casa" id="num_casa">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control" value="<?php echo $cidade ?>" type="text" placeholder="" name="cidade" id="cidade">
                                                    <div class="invalid-feedback">
                                                        Insira a Cidade
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control" value="<?php echo $uf ?>" type="text" placeholder="" name="uf" id="uf">
                                                    <div class="invalid-feedback">
                                                        Insira o UF
                                                    </div>
                                                </div>
                                            ...
                                            <!-- <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control" value="<?php echo $ponto_referencia ?>" type="text" placeholder="" name="pnt_refer" id="pnt_refer">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control" value="<?php echo $telefone_contato ?>" type="text" maxlength="14" placeholder="" name="tel_Contato" id="tel_Contato" oninput="formatarTelefone(this)">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control" value="<?php echo $celular_contato ?>" type="text" maxlength="14" placeholder="" name="cel_Contato" id="cel_Contato" oninput="formatarCelular(this)">
                                                    <div class="invalid-feedback">
